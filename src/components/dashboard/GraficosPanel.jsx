...
function buildEstadoData(data) {
  return {
    ...
    statuses: [
      ...
      { label: 'Confirmadas', value: data.filter(a => a.status === 'confirmed').length,  color: 'var(--accent)' },
        ...
        <div className="grafico-card" style={{ animationDelay: '600ms' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: '1.5rem', color: 'var(--accent)' }}>
                {retencion.nuevos}
              </p>
            </div>
            <div>
